...
to install the Dataverse Network (DVN) software version 1.3.
...
- DVN-EAR_v1_3.xxx.ear 

- config_v1_3.zip, config files to be put into the glassfish
  domain directory (includes its own short README).  

- referenceData_v1_3.sql
