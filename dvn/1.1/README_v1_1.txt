...
to install the Dataverse Network (DVN) software version 1.1.
...
- config.zip, config files to be put into the glassfish
...
Files needed for an upgrade from v1.0:

- DVN-EAR.ear

- buildupdate_v1_0_v1_1.sql
